...
<div >
  ...
  <table class="table">
    ...
    <?php
      ...
      // Câu lệnh SQL để lấy các danh mục sản phẩm duy nhất từ cột 'product_category' của bảng 'products'
    ...
    <tr>
      ...
      <td class="text-center">
        <button class="btn btn-danger" style="height:40px" onclick="categoryDelete('<?=$row['product_category']?>')">Delete</button>
      </td>
    </tr>
    <?php
          $count++;
